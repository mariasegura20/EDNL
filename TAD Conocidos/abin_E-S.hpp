...
template <typename T>
void rellenarAbin(AbinEnla<T>& A, const T& fin)
{
   T e;
...
template <typename T>
void rellenarDescendientes(typename AbinEnla<T>::nodo n, AbinEnla<T>& A, const T& fin)
{
   T ehi, ehd;

   assert(A.hijoIzqdo(n) == AbinEnla<T>::NODO_NULO &&
          A.hijoDrcho(n) == AbinEnla<T>::NODO_NULO);
...
template <typename T>
void rellenarAbin(istream& is, AbinEnla<T>& A)
{
   T e, fin;
...
template <typename T>
void rellenarDescendientes(istream& is, typename AbinEnla<T>::nodo n, AbinEnla<T>& A, const T& fin)
{
   T ehi, ehd;

   assert(A.hijoIzqdo(n) == AbinEnla<T>::NODO_NULO && A.hijoDrcho(n) == AbinEnla<T>::NODO_NULO);
   if (is >> ehi && ehi != fin) {
      A.insertarHijoIzqdo(n, ehi);
...
template <typename T>
void imprimirAbin (const AbinEnla<T>& A)
{
   if (!A.arbolVacio()) {
...
template <typename T>
void imprimirDescendientes (typename AbinEnla<T>::nodo n, const AbinEnla<T>& A)
{
   if (A.hijoIzqdo(n) != AbinEnla<T>::NODO_NULO) {
      cout << "Hijo izqdo de " << A.elemento(n) << ": " << A.elemento(A.hijoIzqdo(n)) << endl;
      imprimirDescendientes(A.hijoIzqdo(n), A);
   }
   if (A.hijoDrcho(n) != AbinEnla<T>::NODO_NULO) {
      cout << "Hijo derecho de " << A.elemento(n) << ": " << A.elemento(A.hijoDrcho(n)) << endl;
...
template <typename T>
void imprimirAbin (ostream& os, const AbinEnla<T>& A, const T& fin)
{
   if (!A.arbolVacio()) {
...
template <typename T>
void imprimirDescendientes (ostream& os, typename AbinEnla<T>::nodo n, const AbinEnla<T>& A, const T& fin)
{
   if (A.hijoIzqdo(n) != AbinEnla<T>::NODO_NULO) {
